...
| System | Role | Current Edentität material | Public handling |
| --- | --- | --- | --- |
...
```text
Notion living definition
        |
        | review + public-boundary check
        v
GitHub public concept mirror
        |
        | release / citation linkage
        v
Zenodo citable archive
```

Direct correspondence supports provenance, but it is not a public source-of-record
for the full concept definition.

## Notion concept cluster

The reviewed internal cluster currently includes:

1. `Edentität ≠ Identität · Kernkonzept TerraNova`
2. `EDENTITÄT-CANON-001 — Begriffsanker v0.1 (2026-06-08)`
3. `Edentität ≠ KSE ≠ Identität · Kanon-Delta (2026-06-08)`
4. `Meilenstein · 21.03.2026 · FerrAI Edentität verankert`
5. `Outreach-Trace · Christina Ott (Edentität-Begriff) — 2026-06-08`
6. `CIC – Genesis-Physik & Pioneer-Window (Silvi-Layer-Canon)`
7. `TerraNova / FerrAI – Ecosystem Skill`

These titles are listed for traceability. Their private workspace URLs and full
contents are not reproduced.

## Public file map

| Public file | Function |
| --- | --- |
| [`README.md`](README.md) | Definition, distinctions, formation conditions and system map. |
| [`PROVENANCE.md`](PROVENANCE.md) | Separate the Ott/Lill and TerraNova use lines. |
